NOTE: this is only a sample of a contributing policy.
...
Before sending Pull request please make sure submitted code satisfies next code conventions:

* Indentation uses spaces instead of tabs. Tab size is 4 spaces.
* Maximum line length is 110 characters.
* No global variables.
* Use JSHint to validate code.
* Underscore is used to indicate variables that are used internally in the JSDO. These properties are not documented.
* If statement uses curly braces even with one line true and else statements.
