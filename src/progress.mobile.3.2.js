...
/* *****  SessionLogout service implementation code ***** */
	...
	/* Copyright (c) 2013-2015 Progress Software Corporation and/or its subsidiaries or affiliates.
 * All rights reserved.
 *
 * Redistributable Code.
 *
...
function clearTableFieldsOnPage(pageName, jsdo) {
    var element = pageName;
    var fields = jsdo[appconfig.tableRef].getSchema();
    for(var i=0;i<fields.length;i++) {
        var field = fields[i];
        $('#' + element + ' [dsid="' + field.name + '"]').val("");    
    }    
}
